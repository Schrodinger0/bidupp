...
@section('content')
    <header class="header">
      ...
      <div class="topnav" id="myTopnav">
        ...
        <a class="active" href="{{ route('welcome') }}">home <img src="{{ asset('images/home.png')}}" alt="" style="height:21px;width:21px;"></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner carousel-height" >
        <div class="item active" >
          <img src="{{ asset('images/banner/thefirstbanner.jpg')}}" class="d-block w-100" alt="">
        </div>
    
        <div class="item" >
          <img src="{{ asset('images/banner/thebanner.jpg')}}" class="d-block w-100" alt="">
        </div>
    
        <div class="item" >
          <img src="{{ asset('images/banner/thenextbanner.jpg')}}" class="d-block w-100" alt="">
        </div>
      </div>
      ...
      <div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="latest">Latest Offers</h3>
          ...
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="BIDUP">For You</h3>
                  </div>
