    ...
    <header class="header">
      ...
      <div class="topnav" id="myTopnav">
       ...
       <a  href="{{ route('products.sport') }}">Sport <img src="{{ asset('images/sport.png')}}" alt="" style="height:21px;width:21px;"></a>
        ...
        <a href="{{ route('products.ville') }}">My City <img src="{{ asset('images/map.png')}}" alt="" style="height:21px;width:21px;"></a>;"></a>
...
<img src="{{ asset('storage/'.Auth::user()->avatar)}}" alt="Avatar" style="  border-radius: 50%; width:150px; heigt:150px;">
  ...
  <p><p id="samir"></p></p>
<p><button onclick="window.location.href='../update'">Update Info</button></p>
</div>
