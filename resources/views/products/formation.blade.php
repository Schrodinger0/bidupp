...
@section('content')
    <header class="header">
      ...
      <div class="topnav" id="myTopnav">
        ...
        <a class="active" href="{{ route('products.formation') }}">Courses <img src="{{ asset('images/formation.png')}}" alt="" style="height:21px;width:21px;"></a>
      ...
      <div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="Courses">Courses</h3>
